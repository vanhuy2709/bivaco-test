...
const AboutWebsite = () => {
  return (
    <div className='flex flex-col gap-4'>
      <h4 className='text-white text-[20px] font-medium leading-[30px]'>About FIFASH</h4>
      ...
      <div className='flex items-center gap-4'>
        ...
        <a href="/gmail" className='text-white text-[14px] font-medium leading-[21px] border-b-[#20B526] border-b py-[6px]'>hvhuy279@gmail.com</a>
      </div>
    </div>
  );
};
